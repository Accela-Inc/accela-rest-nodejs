...
exports.setup = function (config) {
    _config = config;
    if(_config !== null){
        if(_config.base_url !== null && typeof _config.base_url !== "undefined"){
...
// Method to set headers with authorization type.
function setHeaders(auth_type) {
    var headers = {
